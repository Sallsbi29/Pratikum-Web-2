...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query to fetch data of doctor based on id
...
if (isset($_POST['submit'])) {
    ...
    $_telepon = $_POST['telpon'];
    $_alamat = $_POST['alamat'];
    $_unit_kerja_id = $_POST['unit_kerja_id'];
    $data = [$_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telepon, $_alamat, $_unit_kerja_id];
    $sql = "INSERT INTO dokter (nama, gender, tmp_lahir, tgl_lahir, kategori, telepon, alamat, unit_kerja_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
                                    ...
                                    <div class="col-8">
                                        ...
                                        <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
                                            ...
                                            foreach ($rsUnitKerja as $rowUnitKerja) {
                                                echo "<option value=\"" . $rowUnitKerja['id'] . "\">" . $rowUnitKerja['nama'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
